...
Singleton {
    ...
    property int colorTemperature: Config.options?.light?.night?.colorTemperature ?? 3000
    ...
    function enable() {
        ...
        Quickshell.execDetached(["bash", "-c", `pidof hyprsunset || hyprsunset --temperature 2500`]);
    }
